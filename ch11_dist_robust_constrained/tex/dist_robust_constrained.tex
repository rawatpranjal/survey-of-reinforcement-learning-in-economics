...
near the DP optimum (return $254 \pm 6$ versus 273) but
violates the carbon budget by a factor of three
(cost $95 \pm 5$ versus $d = 31$).
The learned multiplier rises from zero and settles at
$\lambda \approx 1.39$, near the analytical shadow price
$\lambda^* = 1.20$. Across the five seeds the trajectory
is nearly monotone: the peak value is $1.407 \pm 0.003$,
...
at $23 \pm 2$, below the budget of 31, leaving the
Lagrangian agent slightly too conservative
(return $172 \pm 3$ versus the LP optimum of 186).
...
Solid lines are means over five seeds; shaded bands are
$\pm 1$ standard error.}
...
fraction of the oracle gap; this is the expected price of not knowing the
true model, not a deficiency of the method.
