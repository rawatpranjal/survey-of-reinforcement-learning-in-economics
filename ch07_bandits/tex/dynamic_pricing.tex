...
The Engine Replacement MDP does not appear because a bandit has no action-dependent state transition. Removing that transition is the defining reduction from an MDP to the model studied here.
