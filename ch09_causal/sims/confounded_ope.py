...
from sims.plot_style import apply_style, COLORS, DOMAIN_COLORS, BENCH_STYLE, FIG_SINGLE, FIG_DOUBLE
...
def generate_outputs(data):
    ...
    # --------------------------------------------------------
    # Combined figure: bias vs rho (left) + IV strength box plot (right)
    # --------------------------------------------------------
    fig, (ax, ax_iv) = plt.subplots(1, 2, figsize=FIG_DOUBLE)
    ...
    ax_iv.legend(loc="best", framealpha=0.9)
    ax_iv.set_title("(b) IV variance vs. instrument strength")
