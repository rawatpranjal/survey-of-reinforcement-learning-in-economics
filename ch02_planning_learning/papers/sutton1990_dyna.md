...
Richard  S.  Sutton GTE Laboratories Incorporated Waltham, MA 02254 gutton~gte.com
...
5.  Repeat  K  times:
6. 5.1 Choose a hypothetical world  state and action;
7. 5.2 Predict resultant reward  and  new state using  action model;
8. 5.3 Apply reinforcement learning to  this  hypothetical experience.
