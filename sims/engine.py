...
def solve_optimal(P, r, gamma, tol=1e-12, max_iter=10000):
    ...
    for _ in range(max_iter):
        ...
        raise RuntimeError(
            f"Optimal-value iteration did not converge within {max_iter} iterations"
        )
...
def solve_ev(P, r, gamma, sigma, tol=1e-12, max_iter=100000):
    ...
    for _ in range(max_iter):
        ...
        raise RuntimeError(
            f"Smoothed-value iteration did not converge within {max_iter} iterations"
        )
    v = r + gamma * P @ W
