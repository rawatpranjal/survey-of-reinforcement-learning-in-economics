...
|---|---|---|---|---|
| `murphy2003dtr` | Foundational | Defines DTR backward induction and motivates it with Fast Track. The chapter states its own formal regularity conditions. | `murphy2003dtr.md` | Full text checked |
