...
\caption{Policy value (as \% of DP optimal) versus behavioral policy randomness $\epsilon_b$ for four offline RL methods and the behavioral cloning baseline (BC). Higher $\epsilon_b$ increases data coverage.}
