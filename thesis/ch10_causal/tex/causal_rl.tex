...
Unlike the online algorithms of Section~\ref{section:rl_algorithms}, where behavior and target policies were identical or related by a known exploration mechanism, here $\mu$ is an unknown function of unobserved variables.
