...
# expands under a logging law far from it. Uses the two-state Engine Replacement MDP, small enough
...
# The environment, the policies and the feature are fixed by the Engine Replacement MDP, so
...
def _setup():
    """Rebuild the Engine Replacement MDP primitives and the two weightings."""
...
def generate_outputs(data):
    ...
    with open(tex_path, "w") as f:
        ...
        f.write(
            "\\caption{The projected Bellman operator on the Engine Replacement MDP under three "
